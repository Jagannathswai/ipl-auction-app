...
//         </div>
//         {isAdmin && <button className="btn btn-primary" onClick={openAdd}><MdAdd size={18} /> Create Team</button>}
//       </div>
...
//                 {isAdmin ? (
//                   <div>
//                     <label style={{ fontSize: '11px', color: 'var(--text-muted)', fontFamily: 'Rajdhani', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'block', marginBottom: '4px' }}>Owner</label>
...
//                   <MdPeople size={14} /> {team.players?.length || 0} / {team.maxPlayers} players
//                 </div>
...
//                   background: form.primaryColor, border: '2px dashed var(--border)',
